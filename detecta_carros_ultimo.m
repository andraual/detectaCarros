...
videoReader = vision.VideoFileReader('C:\Users\Andre\Desktop\UFABC\TG\video2.avi');
for i = 1:150
...
while ~isDone(videoReader)
    ...
    %a=text(double(Af),double(Bf), strcat('X: ', num2str(round(double(A))), '    Y: ', num2str(round(double(B)))));
    result = insertShape(frame, 'Rectangle', bbox, 'Color', 'green');
    numCars = size(bbox, 1);
